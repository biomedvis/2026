...
As a starting point, we organized the first fully ***virtual Bio+Med+Vis*** Spring School in 2021, which offered a set of talks on various visualization subjects from prestigious and established Bio+Med+Vis researchers, addressing different Life Sciences domains. This initiative then continued as a hybrid and in-person events in ***Brno, Czechia (2022)***, ***Norrköping, Sweden (2023)***, ***Magdeburg, Germany (2024)***, and ***Delft, The Netherlands (2025)***. This year the event is collocated with the EG VCBM conference, which will be held on September 16th-18th in Ljubljana, Slovenia.
